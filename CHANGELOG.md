...
- Reduced self-wake noise: generic attention digests no longer fire for message-only attention, because inbox watcher/recovery already deliver the concrete message follow-ups.
